import extractRelationsNLTKCorpus, evalInputBaseLine, mln2experimentOne, evalInputZero, mln2experimentZero, shutil, pickle, time, urllib2, sqlite3, sys
...
def main():
    ...
    try:
        ...
        urlExemplarChunks = divideURLsInChunks(urls, 10) #list of lists
