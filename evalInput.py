...
//formulas
wordSense(tPSIO, +v_ws) ^ featCONJCOUNT(tPSIO, +v_f4)
wordSense(tPSIO, +v_ws) ^ featDEPENSUBARG1(tPSIO, +v_f5)
wordSense(tPSIO, +v_ws) ^ featDEPENSUBARG2(tPSIO, +v_f6)
wordSense(tPSIO, +v_ws) ^ featDEPENSUBARG3(tPSIO, +v_f7)
wordSense(tPSIO, +v_ws) ^ featDEPENHEADARG1(tPSIO, +v_f1)
wordSense(tPSIO, +v_ws) ^ featDEPENHEADARG2(tPSIO, +v_f2)
wordSense(tPSIO, +v_ws) ^ featDEPENHEADARG3(tPSIO, +v_f3)
wordSense(tPSIO, +v_ws) ^ featNEARG1(tPSIO, +v_f8)
wordSense(tPSIO, +v_ws) ^ featNEARG2(tPSIO, +v_f9)
wordSense(tPSIO, +v_ws) ^ featNEARG3(tPSIO, +v_f10)
""")
    f.close()
