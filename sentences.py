...
dictVerbToGoldStandardSentences = dict()

#----------------- argue -----------------
dictVerbToGoldStandardSentences["argue"] = []

dictVerbToGoldStandardSentences["argue"].append([r"Nellie was in the kitchen , had just come to work , when she heard Tim arguing with Julia in the living room .",
...
dictVerbToGoldStandardSentences["argue"].append([r"For example , in Burma and Ceylon many Buddhists argue that Buddhism ought to be the official state religion .",
...
#----------------- base -----------------
dictVerbToGoldStandardSentences["base"] = []

dictVerbToGoldStandardSentences["base"].append([r"School for Conflict Analysis and ResolutionFrom Wikipedia , the free encyclopediaThe School for Conflict Analysis and Resolution -LRB- S-CAR -RRB- EstablishedThe School for Conflict Analysis and Resolution -LRB- S-CAR -RRB- is a division of George Mason University based near Washington and D.C. and United States with locations in Arlington and Fairfax , and Lorton and Virginia .",
...
dictVerbToGoldStandardSentences["base"].append([r"The Center for Universal Design at NCSU established a set of Principles of Universal Design based on UD to guide and evaluate the design process , with a goal toward creating more accessible products and environments .",
...
#----------------- be -----------------
dictVerbToGoldStandardSentences["be"] = []

dictVerbToGoldStandardSentences["be"].append([r"The Fine Arts Center is home to the School of Art and houses classrooms , a studio , workshop spaces , art galleries a glassblowing studio and faculty offices .",
...
dictVerbToGoldStandardSentences["be"].append([r"You remember the words of President Kennedy a week or so ago , when someone asked him when he was in Canada , and Dean Rusk was in Europe , and Vice President Johnson was in Asia , `` Who is running the store '' ?",
...
#----------------- begin -----------------
dictVerbToGoldStandardSentences["begin"] = []

dictVerbToGoldStandardSentences["begin"].append([r"Best Fest and Fiesta UTSA -LRB- edit -RRB- The 2013 Fiesta UTSAFiesta UTSA , an annual event held in April , began in 1978 .",
...
dictVerbToGoldStandardSentences["begin"].append([r"Roberta and Dave began to back toward the door .",
...
#----------------- bring -----------------
dictVerbToGoldStandardSentences["bring"] = []

dictVerbToGoldStandardSentences["bring"].append([r"Barton was relieved to see that Carl Dill and Emmett Foster had brought extra mounts .",
...
dictVerbToGoldStandardSentences["bring"].append([r"With that possibility in mind , Arkansas ' Wilbur Mills deliberately delayed calling a meeting of the Committee on Committees , and coolheaded Democrats sought to bring Rayburn and Smith together again to work out some sort of face-saving compromise .",
...
#----------------- call -----------------
dictVerbToGoldStandardSentences["call"] = []

dictVerbToGoldStandardSentences["call"].append([r"when his Holiness Pope John 23 , first called for an Ecumenical Council , and at the same time voiced his yearning for Christian unity , the enthusiasm among Catholic and Protestant ecumenicists was immediate .",
...
dictVerbToGoldStandardSentences["call"].append([r"Simply call Mr. Whipsnade Oscar , and Dr. Dunne P. GA , and C'un Major Frank .",
...
dictVerbToGoldStandardSentences["call"].append([r"A Sonata For Violin And Piano , called `` Bella Bella '' , by Robert Fleming , was given its first United States performance .",
...
dictVerbToGoldStandardSentences["call"].append([r"He quickly called on Ghana and Tunisia and Morocco and Guinea and Mali , which dispatched troops within hours .",
...
dictVerbToGoldStandardSentences["call"].append([r"On July 18th , 2014 , it was announced that Erskine College and Seminary called Dr. Paul Kooistra , an ordained minister in the Presbyterian Church in America , as their president .",])

#----------------- conduct -----------------
dictVerbToGoldStandardSentences["conduct"] = []

dictVerbToGoldStandardSentences["conduct"].append([r"I heard the Classical Symphony for the first time when Koussevitzky conducted it in Paris in 1927 .",
...
dictVerbToGoldStandardSentences["conduct"].append([r"The TAKS results follow the results of an independent evaluation by Rockman et al. , an independent research and evaluation firm based in San Francisco that was conducted in Grand Prairie ISD in early 2010 .",
...
#----------------- enter -----------------
dictVerbToGoldStandardSentences["enter"] = []

dictVerbToGoldStandardSentences["enter"].append([r"The following morning , as John entered the Place Molard on his way to visit a sick refugee , he had a premonition of danger .",])

dictVerbToGoldStandardSentences["enter"].append([r"In November 2006 , SCC entered into a unique partnership with the Eastern Band of Cherokee Indians that created the Oconaluftee Institute for Cultural Arts -LRB- OICA -RRB- in Cherokee and North Carolina .",
...
#----------------- follow -----------------
dictVerbToGoldStandardSentences["follow"] = []

dictVerbToGoldStandardSentences["follow"].append([r"Phil followed Eddie into the office and shut the door .",
...
dictVerbToGoldStandardSentences["follow"].append([r"It is followed by Cain Street and Piedmont Avenue and NE ; ;",
...
#----------------- give -----------------
dictVerbToGoldStandardSentences["give"] = []

dictVerbToGoldStandardSentences["give"].append([r"All belong to the collection being given to Wilmington over a period of years by Mrs. Sloan , who has cherished such revelatory items ever since she first studied with Sloan at the Art Students League , New York , in the 1920 's .",
...
dictVerbToGoldStandardSentences["give"].append([r"In 2012 , the British Academy invited AuthorAID at INASP to talk about mentoring at the Career Development Workshop for Early Career Researchers in West Africa , and a talk on mentoring was also given at the 11th General Assembly of the European Association of Science Editors .",
...
#----------------- have -----------------
dictVerbToGoldStandardSentences["have"] = []

dictVerbToGoldStandardSentences["have"].append([r"LSU also has an active Society of American Archivists student chapter .",
...
dictVerbToGoldStandardSentences["have"].append([r"The Netherlands and Germany and Denmark and Belgium and France have between 30 and 10 % of their researchers coming from foreign countries .",
...
#----------------- head -----------------
dictVerbToGoldStandardSentences["head"] = []

dictVerbToGoldStandardSentences["head"].append([r"By rough estimate her Committee , headed by Henry Francis Du Pont , contains three times as many Republicans as Democrats .",
...
dictVerbToGoldStandardSentences["introduce"].append([r"Still another approach to the changeable letter type of sign is a modular unit introduced by Merritt Products , Azusa and Calif. .",
...
#----------------- know -----------------
dictVerbToGoldStandardSentences["know"] = []

dictVerbToGoldStandardSentences["know"].append([r"Both Baker and Fosdick knew that a substitute was necessary , that a verboten approach was not the real answer .",
...
dictVerbToGoldStandardSentences["know"].append([r"Until 2008 , Glynd University was known as the North-East Wales Institute of Higher Education -LRB- NEWI -RRB- .",
...
#----------------- lead -----------------
dictVerbToGoldStandardSentences["lead"] = []

dictVerbToGoldStandardSentences["lead"].append([r"With the most casual and relaxed manner in the world , Dolores led Anthea to the bedroom .",
...
dictVerbToGoldStandardSentences["lead"].append([r"according to many critics , in fact , the South has led the North in literature since the Civil War , both quantitatively and qualitatively .",
...
dictVerbToGoldStandardSentences["lead"].append([r"Started in the fall of 2010 , the Entrepreneurship and Innovation Program is led by Director Jay A. Smith .",
...
#----------------- live -----------------
dictVerbToGoldStandardSentences["live"] = []

dictVerbToGoldStandardSentences["live"].append([r"Little by little , during the week , Chris and I discovered the crazy unbelievable way Nadine and Wally had lived .",])

dictVerbToGoldStandardSentences["live"].append([r"Both Red McIver and Handley Walker lived nearby , almost as near as I do .",
...
dictVerbToGoldStandardSentences["live"].append([r"`` The Moral Creed '' and `` The Will To Risk '' live happily together , if we do not examine where the line is to be drawn .",])

#----------------- make -----------------
dictVerbToGoldStandardSentences["make"] = []

dictVerbToGoldStandardSentences["make"].append([r"The New Testament offered to the public today is the first result of the work of a joint committee made up of representatives of the Church of England , Church of Scotland , Methodist Church , Congregational Union , Baptist Union , Presbyterian Church of England , Churches in Wales , Churches in Ireland , Society of Friends , British and Foreign Bible Society and National Society of Scotland .",
...
dictVerbToGoldStandardSentences["make"].append([r"National Pan-Hellenic Council is made up of 9 organizations , 5 Fraternities and 4 Sororities , that were founded on Historically Black College and Universities -LRB- HBCU 's -RRB- .",
...
#----------------- move -----------------
dictVerbToGoldStandardSentences["move"] = []

dictVerbToGoldStandardSentences["move"].append([r"They do not move to Chicago , they move to the South Side ; ;",
...
dictVerbToGoldStandardSentences["move"].append([r"The second half of the 20th century saw Washington and Lee move from being an all-men 's college to a co-ed university .",])

#----------------- operate -----------------
dictVerbToGoldStandardSentences["operate"] = []

dictVerbToGoldStandardSentences["operate"].append([r"The college also operates the SAU Tech Career Academy , the Ouachita County Adult Education Center , the Arkansas Fire Training Academy , and the Arkansas Environmental Training Academy .",
...
dictVerbToGoldStandardSentences["operate"].append([r"There are 51 scientific and scholarly associations , societies and unions affiliated with the SAS , which operate in accordance with the Law on Civic Associations .",
r"'' Kenyon , Sewanee , and Hudson operated in an `` Anglo-Protestant New Critical chill '' ; ;",])

#----------------- place -----------------
dictVerbToGoldStandardSentences["place"] = []

dictVerbToGoldStandardSentences["place"].append([r"Last year Susan also placed 3rd in the Finals at Westminster .",
...
dictVerbToGoldStandardSentences["place"].append([r"From the records we keep , Susan is the only Junior who has placed in the Junior Classes in both United States and Canada .",
...
#----------------- play -----------------
dictVerbToGoldStandardSentences["play"] = []

dictVerbToGoldStandardSentences["play"].append([r"Louis Seigner , who formerly played the deluded benefactor opposite Ledoux , is the Tartuffe of the present production , which he himself directed .",
...
dictVerbToGoldStandardSentences["play"].append([r"SMU will play the Owls at Rice Stadium in Houston in a night game Saturday , Oct. 21 .",
...
dictVerbToGoldStandardSentences["play"].append([r"In recent years Anna Xydis has played with the New York Philharmonic and at Lewisohn Stadium , but her program last night at Town Hall was the Greek-born pianist 's first New York recital since 1948 .",
r"Music lovers who are not familiar with this literature may hear an excellent example , played for RCA by Emil Gilels .",])

#----------------- run -----------------
dictVerbToGoldStandardSentences["run"] = []

dictVerbToGoldStandardSentences["run"].append([r"The Boulevard De La Madeleine , the Boulevard Malesherbes , and the Rue Royale ran to it with graceful flattery , bearing tidings of the Age of Reason .",
...
dictVerbToGoldStandardSentences["run"].append([r"During Dulles 's first two years in office , while Republicans ran the Senate , the Department was at the mercy of men who had thirsted for its blood since 1945 .",
...
#----------------- serve -----------------
dictVerbToGoldStandardSentences["serve"] = []

dictVerbToGoldStandardSentences["serve"].append([r"Tibet has historically served China as a buffer state .",
...
dictVerbToGoldStandardSentences["serve"].append([r"The 1946 town meeting voted to have the Selectmen appoint a committee to investigate and report on the feasibility of some system of sewage disposal and a disposal plant to serve Manchester Center , Depot , and Way 's Lane .",
...
dictVerbToGoldStandardSentences["serve"].append([r"Hester College , named for Cleo Gillis Hester , who served Murray State University from 1927 , as registrar .",
...
#----------------- succeed -----------------
dictVerbToGoldStandardSentences["succeed"] = []

dictVerbToGoldStandardSentences["succeed"].append([r"Pfaff succeeds Martin Burke , who resigned .",
...
dictVerbToGoldStandardSentences["succeed"].append([r"A burlesque paean entitled : `` Hark The Herald Tribune , Times , And All The Other Angels Sing '' brilliantly succeeds in exaggerating even motion-picture ballyhooey .",
...
#----------------- take -----------------
dictVerbToGoldStandardSentences["take"] = []

dictVerbToGoldStandardSentences["take"].append([r"A weapons carrier took Greg , Todman , Belton , Banjo Ferguson , and Walters and the others the two miles from the bivouac area to the strip .",
...
dictVerbToGoldStandardSentences["take"].append([r"In the midst of this gloom , at 10:05 P.M. on September 2 , Slocum 's telegram to Stanton , `` General Sherman has taken Atlanta '' , shattered the talk of a negotiated peace and boosted Lincoln into the White House .",
r"The Federal forces had taken Parkersburg and Grafton from the Rebels and were moving to take all the mountains .",])

dictVerbToGoldStandardSentences["take"].append([r"Harold , with brothers Frank , Joe and William , took over at the death of their father , Harry M. Stevens , who put a few dollars into a baseball program , introduced the `` hot dog '' and paved the way for creation of a catering empire .",
r"Olivetti took over Underwood , the U.S. typewriter maker , in late 1959 .",])

#######
sentences = []
for verb in dictVerbToGoldStandardSentences.keys():
