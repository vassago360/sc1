...
"Social WorkHuman Service Academic Programs & Development -LRB- edit -RRB- Chenault and Burnford argued that human services programs must educate and train students at the graduate or postgraduate level if human services hoped to be considered a professional discipline .", 
"-LRB- Qualitative Thought 1930 -RRB- Louis Menand argues in The Metaphysical Club that Jane Addams had been critical of Dewey 's emphasis on antagonism in the context of a discussion of the Pullman strike of 1894 .", 
...
"The architect Eero Saarinen , based in Birmingham and Michigan , created one of the early master plans for North Campus and designed several of its buildings in the 1950s , including the Earl V. Moore School of Music Building .", 
"The Center for Universal Design at NCSU established a set of Principles of Universal Design based on UD to guide and evaluate the design process , with a goal toward creating more accessible products and environments .", 
"The Academic Bill of Rights is based on the Declaration of Principles on Academic Freedom and Academic Tenure as published by the American Association of University Professors in 1915 , and modified in 1940 and 1970 .", 
"The Seminole County Economic Development Department and the Seminole County Regional Chamber of Commerce are also based at the center .", 
"School for Conflict Analysis and ResolutionFrom Wikipedia , the free encyclopediaThe School for Conflict Analysis and Resolution -LRB- S-CAR -RRB- EstablishedThe School for Conflict Analysis and Resolution -LRB- S-CAR -RRB- is a division of George Mason University based near Washington and D.C. and United States with locations in Arlington and Fairfax , and Lorton and Virginia .", 
...
"Parkview Campus -LRB- edit -RRB- College of Engineering and Applied Sciences , Parkview CampusThe Parkview Campus is home to the University 's College of Engineering and Applied Sciences and the Business Technology and Research Park .", 
...
"In research , UAMS is well known as a leader in multiple myeloma , geriatrics , vision , and spine treatment research and is home to the Arkansas Biosciences Institute and the UAMS Bioventures Business Incubator .", 
"UAMS is also home to 240 physicians featured in the list of Best Doctors in America , some of which are at Arkansas Children 's Hospital and Central Arkansas Veteran 's Healthcare System , where UAMS faculty serve as staff .", 
"Among notable alumni are Neil Armstrong , the first human to step on the moon ; George Lucas , creator of the Star Wars trilogy ; Hollywood screen legend John Wayne -LRB- who also played in the USC football team -RRB- ; world-renowned architect Frank Gehry ; and deposed Egyptian president Mohamed Morsi , the first democratically-elected president in that country 's history .", 
"Salem College is home to the Salem College Center for Women Writers .", 
"The Ambler campus Ambler College , which is home to the Community and Regional Planning , Landscape Architecture , and Horticulture Departments , has changed their name in 2009 to the School of Environmental Design , due to the campus focus on environmental sustainability .", 
...
"-LRB- citation needed -RRB- However , it should be noted that John Dewey was in China in the early 1900s and his ideas were extremely popular .", 
"Last summer John and Elizabeth Sherrill were in Alaska .", 

#----------------- begin -----------------
"Best Fest and Fiesta UTSA -LRB- edit -RRB- The 2013 Fiesta UTSAFiesta UTSA , an annual event held in April , began in 1978 .", 
...
"In 2012 , University College London began its interdisciplinary Arts and Sciences BASc degree -LRB- which has kinship with the liberal arts model -RRB- with 80 students .", 
...
"Classes began in the Correll Science Complex in January 2009 .", 
"The University began in earnest in 1925 when George E. Merrick , the founder of Coral Gables , gave 160 acres -LRB- 0.6 -RRB- and nearly $ 5 , -LRB- $ 67.2 million , adjusted for current inflation -RRB- to the effort .", 
...
"Main article : Backward designUnderstanding by Design relies on what Wiggins and McTighe call `` backward design '' -LRB- also known as `` backwards planning '' -RRB- .", 
"-LRB- July 2013 -RRB- Campbell University was founded as a community school on January 5 , 1887 called Buies Creek Academy .", 
...
"On July 18th , 2014 , it was announced that Erskine College and Seminary called Dr. Paul Kooistra , an ordained minister in the Presbyterian Church in America , as their president .", 
...
"The TAKS results follow the results of an independent evaluation by Rockman et al. , an independent research and evaluation firm based in San Francisco that was conducted in Grand Prairie ISD in early 2010 .", 
"Significant forward motion was accomplished by the first National Holistic Education Conference that was conducted with The University of California , San Diego in July 1979 , that included 31 workshops .", 
"In 1997 , The National Institute of Justice -LRB- NIJ -RRB- and the United States Bureau of Justice Statistics -LRB- BJS -RRB- conducted the National College Women Sexual Victimization -LRB- NCWSV -RRB- survey .", 

#----------------- enter -----------------
"The following morning , as John entered the Place Molard on his way to visit a sick refugee , he had a premonition of danger .", 

"In November 2006 , SCC entered into a unique partnership with the Eastern Band of Cherokee Indians that created the Oconaluftee Institute for Cultural Arts -LRB- OICA -RRB- in Cherokee and North Carolina .", 
"NTCC and Texas A & M University at College Station have entered into an articulation agreement to provide a seamless transition for students who completed the Associate of Science Degree in Biomedical Science at NTCC to a Bachelor of Science Degree in Biomedical Science at Texas A & M. NTCC students must complete the A.S. degree with a 3.6 GPA , with no grades below `` B '' in science and math .", 
...
"By 1894 , Dewey had joined Tufts , with whom he would later write Ethics -LRB- 1908 -RRB- , at the recently founded University of Chicago and invited Mead and Angell to follow him , the four men forming the basis of the so-called `` Chicago group '' of psychology .", 

"It is followed by Cain Street and Piedmont Avenue and NE ; ;", 
"The largest college , in terms of enrollment , is the Carnegie Institute of Technology with 400 students in the class of 2017 , followed by the Dietrich College of Humanities & Social Sciences with 265 , and the College of Fine Arts with 260 .", 
"The first and best known of these schools is St. John 's College in Annapolis and Santa Fe -LRB- program established in 1937 -RRB- ; it was followed by Shimer College in Chicago , The Integral Program at Saint Mary 's College of California -LRB- 1955 -RRB- , The College of Saint Mary Magdalen in Warner , New Hampshire , and Thomas Aquinas College in Santa Paula and California .", 
"She and Bodichon founded the first higher educational institution for women , with five students , which became Girton College , Cambridge in 1873 , followed by Lady Margaret Hall at Oxford in 1879 .", 
"The first Liberal Arts degree program in Sweden was established at Gothenburg University in 2011 , followed by a Liberal Arts Bachelor Programme at Uppsala University 's Campus Gotland in the autumn of 2013 .", 
...
"In 2012 , the British Academy invited AuthorAID at INASP to talk about mentoring at the Career Development Workshop for Early Career Researchers in West Africa , and a talk on mentoring was also given at the 11th General Assembly of the European Association of Science Editors .", 
"Franklin Delano Roosevelt gave a summer commencement address at the University of Georgia in 1938 .", 
"Overall , six U.S. presidents and three foreign presidents have given Landon Lectures at K-State since the series was inaugurated in 1966 .", 

#----------------- have -----------------
"LSU also has an active Society of American Archivists student chapter .", (college has society)
"See also : Lombardi Scholars Program and Reitz Scholars ProgramThe University of Florida has a nationally recognized honors program .", 
"Academic profile -LRB- edit -RRB- NCTC has a Lifelong Learning Division that recently held the first-ever Weld-Off with over 155 registrations and 42 participants .", 
"The university has two National Science Foundation Engineering Research Centers : the Integrated Media Systems Center and the Center for Biomimetic Microelectronic Systems .", 

"The Netherlands and Germany and Denmark and Belgium and France have between 30 and 10 % of their researchers coming from foreign countries .", 
"Brazil and Spain and Japan and Italy and India have less than 10 % of their researchers coming from foreign countries .", 
"According to historian Joel Ricks in 1938 , '' Provo had received the Insane Asylum , Salt Lake City had the University and Capitol , and the majority of the legislature felt that the new institutions should be given to Weber and Cache Counties . ''", 
"Canada and Australia , the United States and Sweden and the United Kingdom have between 50 and 30 % of their researchers coming from foreign countries .", 
...
"The Museum of Art was founded in 1936 and originally headed by Oscar Jacobson , the director of the School of Art at the time .", 
"The University of Arizona Honors College is in affiliation with the University of Arizona and is headed by Dean Dr. Patricia MacCorquodale and Associate Dean Dr. Laura Berry .", 
"The Andrew and Erna Viterbi School of Engineering is headed by Dean Yannis Yortsos .", 
...
"Still another approach to the changeable letter type of sign is a modular unit introduced by Merritt Products , Azusa and Calif. .", 
...
"The first Real Time Research session that was introduced at the conference by Eric Zimmerman , Constance Steinkuehler , and Kurt Squire .", 
"In response , the organization drafted model legislation , called the Academic Bill of Rights , which has been introduced in several state legislatures and the U.S. House of Representatives .", 
...
"Until 2008 , Glynd University was known as the North-East Wales Institute of Higher Education -LRB- NEWI -RRB- .", 
"The University was first officially known as Western State Normal School , and originally offered a 2-year training program .", 
...
"Other buildings on campus include : Malcolm A. Love Library and the InfoDomeThe campus library , now known as the Malcolm A. Love Library , acquired its 100,000 th book on May 21 , 1944 .", 
...
"El Paso -LRB- `` the Pass '' -RRB- Hall is the interior lower level of a bridge that connects the east and west sides of the campus , which are separated by a shallow but picturesque creek originally known as Jackson Branch .", 
"When the school was first established , the Tempe Normal School teams were simply known as the Normals .", 

#----------------- lead -----------------
"With the most casual and relaxed manner in the world , Dolores led Anthea to the bedroom .", (location)
...
"according to many critics , in fact , the South has led the North in literature since the Civil War , both quantitatively and qualitatively .", (ranking)
"In the popular sport of soccer UCLA leads USC in the all-time series 13 , yet USC no longer competes in men 's NCAA Div 1 soccer .", 
"Worldwide -LRB- edit -RRB- Two professors , a graduate , and an undergraduate student at the TAMUQ branch campusTexas A&M has participated in over 500 research projects in over 80 countries and leads the Southwestern United States in annual research expenditures .", 

"Started in the fall of 2010 , the Entrepreneurship and Innovation Program is led by Director Jay A. Smith .", (leader)
"One of the most generous contributors was De Forenede Teglv i Aarhus -LRB- `` The United Tileworks of Aarhus '' -RRB- led by director K. Nymark .", 
"Founded in the fall of 2011 , Integrated Life Sciences is currently led by Director Dr. Todd J. Cooke .", 
"Cooper , a two-time WNBA MVP , led the Lady Panthers to the school 's first ever SWAC title and NCAA Tournament berth in her second season as coach .", 
"David Bassore was announced head coach in 2005 and led the Eagles to a 6-5 record and a district championship .", 
"From 2010-2012 , Wagner Men 's Basketball was coached by Dan Hurley , who led Wagner to a 38 -LRB- 24 NEC -RRB- record in his two seasons before taking the Head Coaching Job at the University of Rhode Island .", 
"RHA is led by an Executive Board and Senate with student representatives from each residence hall hall .", 
...
"A Campaign Steering Committee of alumni and friends is led by co-chairs Patricia V. Reser , James H. Rudd and Patrick F. Stone .", 
...
"After her father 's death , Lucy and her youngest sister lived for a few years with Winslow in Washington and D.C. .", 
"Many years later I went to see S.K. in England , where he was living at Whiteleaf , near Aylesbury , and he showed me beside his cottage there the remains of the road on which Boadicea is supposed to have traveled .", 
...
"As of 2007 , the Board is made up of three Republicans and five Democrats .", 
"Debates Selection Committee -LRB- to operate debating selections -RRB- Made up of the Director of Debating , the President , the Treasurer , the Debates Training Secretary and the Debates Competitions Secretary , the DSC decides which members of the competitive debating squads will go to which competitions and who will be Durham 's adjudicators .", 
"Governance -LRB- edit -RRB- Northeast Mississippi Community is governed locally by a Board of Trustees which is made up of fifteen members members from Prentiss and two each from Alcorn and Tippah and Tishomingo , and Union counties with one member elected at-large by the Board itself .", 
"The college has a music program and supports the Austin College A Cappella Choir along with the Sherman Symphony Orchestra made up of students and local musicians , and assorted smaller musical ensembles .", 

"National Pan-Hellenic Council is made up of 9 organizations , 5 Fraternities and 4 Sororities , that were founded on Historically Black College and Universities -LRB- HBCU 's -RRB- .", 
"Lumbee Hall , the Dial Humanities building , the Sampson building , Auxiliary building , and the Jones Athletic Center make up most of the north end of campus .", 
...
"In the fall of 1913 , H.K. Taylor moved from Missouri where he was president of the Northwest State Teachers ' College to set up another military academy called Arlington Training School .", 
"Thomas Martin , son of a Methodist minister , was born in 1799 and moved to Pulaski Tennessee , as a young man .", 
"In 1908 Rev. Kelley and his bride moved to Orlinda and Tennessee to take the pastorate at Orlinda Baptist Church .", 

"The second half of the 20th century saw Washington and Lee move from being an all-men 's college to a co-ed university .", 

#----------------- operate -----------------
"The college also operates the SAU Tech Career Academy , the Ouachita County Adult Education Center , the Arkansas Fire Training Academy , and the Arkansas Environmental Training Academy .", 
...
"The Software Engineering Institute -LRB- SEI -RRB- is a federally funded research and development center sponsored by the U.S. Department of Defense and operated by Carnegie Mellon University , with offices in Pittsburgh and Pennsylvania and USA ; Arlington and Virginia , and Frankfurt and Germany .", 
"Beginning in Spring of 2004 , Cedar Valley College began operating the Cedar Valley College Center at Cedar Hill .", 
"In addition , the Penn State College of Communications operates ComRadio .", 
"The university also operates the 18-hole Kent State Golf Course and Centennial Research Park just east of campus in Franklin Township and the 219-acre -LRB- 0.9 -RRB- Kent State University Airport in Stow .", 
...
"CMU placed 51st among the top universities in the world in the current Academic Ranking of World Universities -LRB- ARWU -RRB- .", (rank)
"College of Health ProfessionsFairmount College of Liberal Arts and SciencesWichita State is placed among Tier 2 National Universities in the United States .", 

"From the records we keep , Susan is the only Junior who has placed in the Junior Classes in both United States and Canada .",  (status)
...
"The National Park Service placed Pinkerton Hall , the oldest building on campus , on the National Register of Historic Places on November 20 , 1974 .", 
...
"The Prairie View Bowl was played in Texas between 1928 and 1962 .", 
"Former Dragon Brian Wuest now plays for the University of Nebraska at Kearney Lopers .", 
"Notable football players that have achieved success in the National Football League -LRB- NFL -RRB- are National Football Hall of Fame Inductee Kenny Houston , who played for the Houston Oilers and Washington Redskins and Otis Taylor , who won a World Championship with the Kansas City Chiefs in 1969 .", 
"The Cougars play in an extremely talented and competitive JUCO Conference .", 
"11 Wildcats have played in the NFL .", 
...
"The Little Brown Jug , a harness race , is run during the Delaware County Fair in September .",
...
"The International Center for Lightning Research and Testing -LRB- ICLRT -RRB- are run by the University of Florida at the Camp Blanding Florida Army National Guard Base .",
"USC ran the Chaffey College of Agriculture until financial troubles closed the school in 1901 .", 
"In 2001 the Sapling Foundation , run by entrepreneur Chris Anderson , acquired TED .", 
...
"HCS Blue -LRB- # 00a7cf -RRB- and Black -LRB- # 00000 -RRB- Other information : www.horrycountyschools.netH orry County Schools -LRB- HCS -RRB- is a public school district serving Horry County and South Carolina and is the third-largest school district in South Carolina .", 
"Sargeant Reynolds Community College -LRB- Reynolds -RRB- is a community college serving not only Richmond and Virginia , but Goochland County and Hanover County and Henrico County and Louisa County and Powhatan County as well .", 

"Hester College , named for Cleo Gillis Hester , who served Murray State University from 1927 , as registrar .", 
"Previously , Allison served as provost and vice president at Governor 's State University in Illnois where he was also a professor of English .", 
"Immediately before that , Dr. Howard served for fifteen years as a Vice President at the University of North Alabama .", 
"After the dissolution of the system , Alvin Duke Chandler served as the coordinator for Christopher Newport College and Richard Bland College ; however , he resigned this position after only four months .", 
"Gougenheim , R Michea , Paul Rivenc , and Aur Sauvageot served as researchers for the project .", 
"Hutchins served as President of the University of Chicago until 1945 , and as the University 's Chancellor until 1951 .", 
...
"After the school had changed locations several times , Bishop Haven , who succeeded Bishop Clark , was instrumental in acquiring 450 acres -LRB- 1.8 -RRB- in South Atlanta , where in 1880 the school conferred its first degree .", 
"Governor Steve Beshear , who succeeded Fletcher in 2007 , has stated that the state does not plan to appeal this decision .", 
"In 1943 , Dr. Jennings B. Sanders succeeded Jones as president .", 
...
"According to the Food And Drug Administration -LRB- FDA -RRB- , `` Doctor '' Ghadiali , Dr. Albert Abrams and his clique , and Dr. Wilhelm Reich , to name three notorious device quacks , succeeded , respectively , in distributing 10,000 , 5000 , and 2000 fake health machines .", 
...
"Max , in a fit of despair , takes Alicia and runs off for two marvelous weeks in Burbank -LRB- Fink calls it `` the most wonderful and lovely fourteen days in my whole life '' -RRB- , at the end of which Alicia tragically contracts Parkinson 's disease and dies .", 
...
"In his first season , Rodriguez took the Wildcats to the 2012 New Mexico Bowl , where they defeated the University of Nevada Wolfpack .", 
