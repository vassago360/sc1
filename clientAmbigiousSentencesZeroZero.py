...
def processMainLoopException(e, urls):
        ...
        try:
            ...
            subprocess.call(r'ssh st1298@eros.cs.txstate.edu cat taxonomyRelationsZeroZero.db > taxonomyRelations.db', shell=True)
        except:
...
def addBadURLs(urls):
        ...
        subprocess.call(r'ssh st1298@eros.cs.txstate.edu cat < badWikipediaArticles.p ">" ' + 'transportedBWZeroZero' + str(random.randrange(100000)) + '.p', shell=True)

def getBadURLs():
    try:
        subprocess.call(r'ssh st1298@eros.cs.txstate.edu cat badWikipediaArticlesZeroZero.p > badWikipediaArticles.p', shell=True)
    ...
    try:
        for urls in urlExemplarChunks:
            ...
            if enoughToWorkWith:
                ...
                subprocess.call(r'ssh st1298@eros.cs.txstate.edu cat < transportedTR.db ">" ' + 'transportedTRZeroZero' + str(random.randrange(100000)) + '.db', shell=True)
