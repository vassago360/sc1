import extractRelationsNLTKCorpus, evalInputOne, mln2experimentOne, shutil, pickle, time, urllib2, sqlite3, sys
...
def addBadURLs(urls):
        ...
        subprocess.call(r'ssh st1298@eros.cs.txstate.edu cat < badWikipediaArticles.p ">" ' + 'transportedBWOneOne' + str(random.randrange(100000)) + '.p', shell=True)
