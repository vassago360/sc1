...
def findAndAddWordSenses(c1,c2, c3):
    #import pdb ; pdb.set_trace()
    #find tPs in c1 that are not going to go through reduction or zeugma testing
    tPsToAddSameTP = c1.getTPsWithSameTP(c2)
    print("tPsToAddSameTP: (" + str(len(tPsToAddSameTP)) + ") " + str(tPsToAddSameTP))
    #add input textualpatterns that match up
    for tPToAdd in tPsToAddSameTP:
